...
<input type="hidden" name="kunjunganID" value="<?php echo $data['kunjunganID'] ?>"><br>
                ...
                <select name="dokter" id="dokter" class="py-1 ms-4 bg-transparent" size="3" style="width: 39%; background-color: #A2D2FF;">
                    <option value="1" <?php if($data['dokterID'] == '1') echo 'checked'; ?> >Dr. Anisa Dewi, Sp.A. - RSKIA Sadewa</option>
                    <option value="2" <?php if($data['dokterID'] == '2') echo 'checked';?> >Dr. Aditya Pratama, Sp.A. - RSKIA Pratama UPN</option>
                    <option value="3" <?php if($data['dokterID'] == '3') echo 'checked';?> >Dr. Siti Nurul Huda, Sp.A. - RSKIA UGM</option>
                    <option value="4" <?php if($data['dokterID'] == '4') echo 'checked';?> >Dr. Maya Indriani, Sp.A. - RSKIA Hermina</option>
                    <option value="5" <?php if($data['dokterID'] == '5') echo 'checked';?> >Dr. Rina Fitriani, Sp.A. - RSKIA Permata Bunda</option>
                    <option value="6" <?php if($data['dokterID'] == '6') echo 'checked';?>  >Dr. Putri Handayani, Sp.A. - RSKIA Fajar</option>
                    <option value="7" <?php if($data['dokterID'] == '7') echo 'checked';?> >Dr. Amanda Surya, Sp.A. - RSKIA Sadewa</option>
                    <option value="8" <?php if($data['dokterID'] == '8') echo 'checked';?> >Dr. Ratna Cahaya, Sp.A. - RSKIA Pratama UPN</option>
                    <option value="9" <?php if($data['dokterID'] == '9') echo 'checked';?> >Dr. Nina Kusuma, Sp.A. - RSKIA UGM</option>
                    <option value="10" <?php if($data['dokterID'] == '10') echo 'checked';?> >Dr. Dian Pertiwi, Sp.A. - RSKIA Hermina</option>
                    <option value="11" <?php if($data['dokterID'] == '11') echo 'checked';?> >Dr. Aditya Wijaya, Sp.A. - RSKIA Permata Bunda</option>
                    <option value="12" <?php if($data['dokterID'] == '12') echo 'checked';?> >Dr. Maya Putri, Sp.A. - RSKIA Fajar</option>
                </select>
                <br>
