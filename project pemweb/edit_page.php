...
<input type="hidden" name="kunjunganID" value="<?php echo $data['kunjunganID'] ?>"><br>
                ...
                <select name="dokter" id="dokter" class="py-1 ms-4 bg-transparent" size="3" style="width: 39%; background-color: #A2D2FF;">
                    <option value="1" <?php if($data['dokterID'] == '1') echo 'checked'; ?> >Sadewa</option>
                    <option value="2" <?php if($data['dokterID'] == '2') echo 'checked';?> >Pratama UPN</option>
                    <option value="3" <?php if($data['dokterID'] == '3') echo 'checked';?> >UGM</option>
                    <option value="4" <?php if($data['dokterID'] == '4') echo 'checked';?> >UGM</option>
                    <option value="5" <?php if($data['dokterID'] == '5') echo 'checked';?> >UGM</option>
                    <option value="6" <?php if($data['dokterID'] == '6') echo 'checked';?>  >UGM</option>
                    <option value="7" <?php if($data['dokterID'] == '7') echo 'checked';?> >UGM</option>
                    <option value="8" <?php if($data['dokterID'] == '8') echo 'checked';?> >UGM</option>
                    <option value="9" <?php if($data['dokterID'] == '9') echo 'checked';?> >UGM</option>
                    <option value="10" <?php if($data['dokterID'] == '10') echo 'checked';?> >UGM</option>
                    <option value="11" <?php if($data['dokterID'] == '11') echo 'checked';?> >UGM</option>
                    <option value="12" <?php if($data['dokterID'] == '12') echo 'checked';?> >UGM</option>
                </select>
                <br>

                <!-- //infor tambahan  -->
                <label class="ms-5 mt-4" for="info">Informasi Tambahan</label> <br>
                <textarea class="fw-light ms-5 bg-transparent py-1" value="<?php echo $data['addictional_information'] ?>"style="border: none; border-bottom: 1px solid #A2D2FF" name="info" cols="95" rows="2" placeholder="Enter.." required></textarea>
                <br>
                <center>
