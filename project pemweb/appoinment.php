...
<div class=" m-4 ">
    <table class="table table-bordered " style="border: #FEE440;  text-align: center; ">
        ...
        <tr>
            ...
            <td style="color: #ce3046;"><button class="btn btn-light fs-5 py-1 px-2" style="border-color: #ce3046;" ><a href ="delete.php?kunjunganID=<?php echo $data['kunjunganID']; ?>" style="text-decoration: none; color: #ce3046;">  Batalkan </a></button></td>
