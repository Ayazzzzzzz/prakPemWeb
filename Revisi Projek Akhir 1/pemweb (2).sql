...
('bapak sepuh', 'sepuh', 'penyakit merendah', 'aku mah masih pemula, ajarin dong puh sepuh~', 99, '2023-11-28', 1, 2, 1, 3),
('Siapa', 'anak shinta', 'Sakit Tenggorokan', 'Ga ada', 4, '2023-12-08', 0, 6, 3, 11),
('Aku', 'anak shinta', 'Anemia', 'Gaaadaa', 5, '2023-11-16', 0, 6, 2, 12),
...
('puhsepuh', 'sepuh999@gmail.com', 'sepuh', 'inti bumi', '871281872', '1999-08-12', 'gaada', 'di rumah para sepuh inti bumi ', 2),
...
--
ALTER TABLE `dokter`
  MODIFY `dokterID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `kunjungan`
--
ALTER TABLE `kunjungan`
  MODIFY `kunjunganID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
