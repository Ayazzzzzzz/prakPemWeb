...
<html lang="en">
  ...
  <li class="nav-item">
    <a class="nav-link fs-5 mx-3" style="color : #213555;" aria-current="page" href="#">Home</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fs-5 mx-3" style="color : #213555;" aria-current="page" href="artikel_admin.php">Article</a>
  </li>
  <!-- <li class="nav-item">
    <a class="nav-link fs-5 mx-3" style="color : #213555;"  href="contact_hos.php">Contact Us</a>
  </li> -->
  <li class="nav-item">
    <a class="nav-link fs-5 mx-3" style="color : #213555;"  href="location_admin.php">Location</a>
  </li>
  <li class="nav-item">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            ...
            <h6 class="mb-3"><u><?php echo $username?></u></h6>
            <!-- ini nanti kasih gmail dari dbnya ya   -->
        </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="my_profile_admin.php">My Profile (Admin)</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="appoinment_admin.php">Appointment Patients</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="history_admin.php">History Patients</a>
          </li>
