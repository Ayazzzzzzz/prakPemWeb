  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        ...
        <li class="nav-item mt-1 pt-1">
            ...
            <a href="login.php"><button class="btn px-4 rounded-pill fw-semibold fs-5" style="background-color : #A2D2FF;  width: 360px;" type="submit" data-bs-toggle="modal" data-bs-target="#exampleModal" value="login">Login</button>
            </a>
          </li>
      </div>
      </center>
