  ...
  <body style="background-color: #FEF9EF; color: #213555;">
        <center>
            ...
            <div class="row">
                ...
                <select name="dokter" id="dokter" class="py-1 ms-4 bg-transparent" size="2" style="width: 39%; background-color: #A2D2FF;">
                <?php 
                ...
                ?> 
                    <option value="<?php echo $data['dokterID']; ?>"><?php echo $data['nama']; ?></option>
                    <?php } ?>
                </select>
                <br>
